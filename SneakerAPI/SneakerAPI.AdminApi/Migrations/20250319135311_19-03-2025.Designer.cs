...
namespace SneakerAPI.AdminApi.Migrations
{
    ...
    [Migration("20250319135311_19-03-2025")]
            ...
            modelBuilder.Entity("SneakerAPI.Core.Models.OrderEntities.CartItem", b =>
                {
                    ...
                    b.Property<decimal>("CartItem__AmountDue")
                    ...
                    b.Property<decimal>("CartItem__UnitPrice")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("SneakerAPI.Core.Models.OrderEntities.OrderItem", b =>
                {
                    ...
                    b.Property<decimal>("OrderItem__AmountDue")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal>("OrderItem__UnitPrice")
                        .HasColumnType("decimal(18,2)");
